...
export default class LightBoxPromotion extends React.Component {
    render() {
      ...
      window.LightBoxPromotionArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.LightBoxPromotionArray[index].html;
