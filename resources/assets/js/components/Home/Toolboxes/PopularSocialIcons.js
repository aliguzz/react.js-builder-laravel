...
export default class PopularSocialIcons extends React.Component {
    render() {
      ...
      window.PopularSocialIconsArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.PopularSocialIconsArray[index].html;
