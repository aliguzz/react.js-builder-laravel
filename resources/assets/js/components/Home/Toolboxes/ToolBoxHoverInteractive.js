...
export default class ToolBoxInteractive extends React.Component {
  render() {
    ...
    window.boxInteractiveArray = container.boxes;
    return (
      <div style={divStyle}>
        {
          _.map(container.boxes, function (item, index) {
            ...
            return (<div className={"singleElementDragger"} onDragStart={(event) => {
              ...
              var text = window.boxInteractiveArray[index].html;
