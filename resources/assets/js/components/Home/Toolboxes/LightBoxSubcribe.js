...
export default class LightBoxSubcribe extends React.Component {
    render() {
      ...
      window.LightBoxSubcribeArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.LightBoxSubcribeArray[index].html;
