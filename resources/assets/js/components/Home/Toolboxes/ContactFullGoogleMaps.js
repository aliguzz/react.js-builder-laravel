...
export default class ContactFullGoogleMaps extends React.Component {
    render() {
      ...
      window.contactFullGoogleMapsArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.contactFullGoogleMapsArray[index].html;
