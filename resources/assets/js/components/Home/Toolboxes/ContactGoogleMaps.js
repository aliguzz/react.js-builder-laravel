...
export default class ContactGoogleMaps extends React.Component {
    render() {
      ...
      window.contactGoogleMapsArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.contactGoogleMapsArray[index].html;
