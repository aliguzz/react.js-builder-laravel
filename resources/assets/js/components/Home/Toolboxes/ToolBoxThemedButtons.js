...
export default class ToolBoxThemedButtons extends React.Component {
    render() {
      ...
      window.ThemedButtonsArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.ThemedButtonsArray[index].html;
