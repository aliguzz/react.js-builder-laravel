...
export default class LightBoxWelcome extends React.Component {
    render() {
      ...
      window.LightBoxWelcomeArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.LightBoxWelcomeArray[index].html;
