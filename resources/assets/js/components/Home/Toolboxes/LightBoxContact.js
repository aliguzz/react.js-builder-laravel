...
export default class LightBoxContact extends React.Component {
    render() {
      ...
      window.LightBoxContactArray = container.boxes;
      return (
        <div style={divStyle}>
          {
            _.map(container.boxes, function (item, index) {
              ...
              return (<div className="singleElementDragger" onDragStart={(event) => {
                ...
                var text = window.LightBoxContactArray[index].html;
